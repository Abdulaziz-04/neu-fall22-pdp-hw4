...
/**
 * From Rob Camick's Table Button Column (July 12, 2009)
 * [https://tips4java.wordpress.com/2009/07/12/table-button-column/] The ButtonColumn class provides
 * a renderer and an editor that looks like a JButton. The renderer and editor will then be used for
 * a specified column in the table. The TableModel will contain the String to be displayed on the
 * button.
 * <p>
